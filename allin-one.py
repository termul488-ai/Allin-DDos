...
def tcp_syn_flood_single(ip, port, duration):
    ...
    try:
        while time.time() < end_time:
            time.sleep(0.2)
            print("f\033[48;5;1mStarting TCP SYN flood 0ne-threads \033[97m" +str(ip)+ " \033[33m0k..!\033[0m")
            print("\033[91m Starting UDP TCP SYN flood 0ne-threads \033[32m" +str(packet_size)+ " \033[38;5;5mm0k...!\033[0m")
